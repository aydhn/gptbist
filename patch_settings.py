...
if "ENABLE_PERFORMANCE" not in content:
...
"""
    # Insert right before class Settings ends or before the first method
    # Since we can just append it inside the class, we will find a good place.
    content = content.replace("    # --- RESEARCH ORCHESTRATOR / CAMPAIGN RUNNER SETTINGS ---", performance_settings + "\n    # --- RESEARCH ORCHESTRATOR / CAMPAIGN RUNNER SETTINGS ---")
