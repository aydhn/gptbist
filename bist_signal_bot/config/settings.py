...
class Settings(BaseSettings):
    ...
    MAINTENANCE_AUTOMATION_RESEARCH_ONLY: bool = True
    MAINTENANCE_AUTOMATION_SAVE_RESULTS: bool = True

    MAINTENANCE_DEFAULT_DRY_RUN: bool = True
    MAINTENANCE_REQUIRE_CONFIRM_FOR_DESTRUCTIVE: bool = True
    MAINTENANCE_ALLOW_COMMAND_ACTIONS: bool = True
    MAINTENANCE_BLOCK_UNSAFE_COMMANDS: bool = True

    MAINTENANCE_ENABLE_DAILY_POLICY: bool = True
    MAINTENANCE_ENABLE_WEEKLY_POLICY: bool = True
    MAINTENANCE_ENABLE_MONTHLY_POLICY: bool = True
    MAINTENANCE_ENABLE_QUARTERLY_POLICY: bool = True

    MAINTENANCE_CACHE_RETENTION_DAYS: int = 30
    MAINTENANCE_REPORT_RETENTION_DAYS: int = 180
    MAINTENANCE_LOG_RETENTION_DAYS: int = 30
    MAINTENANCE_EXPORT_RETENTION_DAYS: int = 90
    MAINTENANCE_MANIFEST_RETENTION_DAYS: int = 365
    MAINTENANCE_BACKUP_RETENTION_DAYS: int = 365
    MAINTENANCE_TEMP_RETENTION_DAYS: int = 7

    MAINTENANCE_MAX_CACHE_MB: float = 1024.0
    MAINTENANCE_MAX_LOG_MB: float = 512.0
    MAINTENANCE_MAX_REPORT_MB: float = 1024.0

    MAINTENANCE_BACKUP_MANIFEST_ENABLED: bool = True
    MAINTENANCE_BACKUP_COPY_FILES: bool = False
    MAINTENANCE_BACKUP_INCLUDE_CHECKSUMS: bool = True

    MAINTENANCE_CLEANUP_ENABLED: bool = True
    MAINTENANCE_CLEANUP_ARCHIVE_BEFORE_DELETE: bool = True
    MAINTENANCE_CLEANUP_PROTECT_SOURCE_CODE: bool = True
    MAINTENANCE_CLEANUP_PROTECT_CONFIG: bool = True
    MAINTENANCE_CLEANUP_PROTECT_DOCS: bool = True

    RUNTIME_MAINTENANCE_AUTOMATION_ENABLED: bool = True
    QA_INCLUDE_MAINTENANCE_AUTOMATION: bool = True
    OPS_INCLUDE_MAINTENANCE_AUTOMATION: bool = True
    REPORT_INCLUDE_MAINTENANCE_AUTOMATION: bool = True
    RESEARCH_AUTO_LOG_MAINTENANCE_AUTOMATION: bool = False
