...
MAINTENANCE_DIR_NAME: str = "maintenance"
BACKUP_DIR_NAME: str = "backups"
BACKUP_DEFAULT_FORMAT: str = "ZIP"
BACKUP_DEFAULT_SCOPE: str = "ALL_SAFE"
BACKUP_VERIFY_AFTER_CREATE: bool = True
BACKUP_INCLUDE_LOGS: bool = False
BACKUP_INCLUDE_MODEL_ARTIFACTS: bool = False
BACKUP_INCLUDE_MARKET_DATA: bool = True
BACKUP_BLOCK_ON_SECRET_RISK: bool = True

RESTORE_DRY_RUN_DEFAULT: bool = True
RESTORE_REQUIRE_CONFIRM: bool = True
RESTORE_CREATE_PRE_RESTORE_BACKUP: bool = True
RESTORE_BLOCK_SECRET_FILES: bool = True

RETENTION_ENABLE: bool = True
RETENTION_LOGS_DAYS: int = 30
RETENTION_REPORTS_DAYS: int = 180
RETENTION_SCENARIOS_DAYS: int = 90
RETENTION_STRESS_DAYS: int = 180
RETENTION_DRIFT_DAYS: int = 180
RETENTION_RESEARCH_LAB_DAYS: int = 180
RETENTION_TEMP_DAYS: int = 7
RETENTION_SIGNALS_DAYS: int = 365
RETENTION_KEEP_MIN_COUNT: int = 10

CLEANUP_REQUIRE_CONFIRM: bool = True
CLEANUP_ARCHIVE_BEFORE_DELETE: bool = True
CLEANUP_DELETE_MARKET_DATA_DEFAULT: bool = False
CLEANUP_DELETE_RESEARCH_LEDGER_DEFAULT: bool = False

SCHEMA_VERSION: str = "1.0.0"
MIGRATION_REQUIRE_BACKUP: bool = True
MIGRATION_REQUIRE_CONFIRM: bool = True

MAINTENANCE_DOCTOR_DEEP_DEFAULT: bool = False
MAINTENANCE_DOCTOR_CHECK_SECRET_RISK: bool = True
MAINTENANCE_DOCTOR_CHECK_JSONL: bool = True
MAINTENANCE_DOCTOR_CHECK_CSV: bool = True

REPORT_INCLUDE_MAINTENANCE: bool = True
# Scheduler Config Extensions
...
BIST_CALENDAR_FILE = "bist_holidays.csv"
BIST_DEFAULT_OPEN_TIME = "10:00"
BIST_DEFAULT_CLOSE_TIME = "18:00"
BIST_PRE_MARKET_START = "08:30"
BIST_OPENING_START = "09:40"
BIST_INTRADAY_START = "10:00"
BIST_CLOSING_START = "18:00"
BIST_POST_MARKET_START = "18:10"
BIST_AFTER_HOURS_START = "18:30"
BIST_HALF_DAY_CLOSE_TIME = "12:40"

# Default Jobs Config
SCHEDULER_CREATE_DEFAULT_JOBS = True
SCHEDULER_ENABLE_HEALTHCHECK_DAILY = True
SCHEDULER_ENABLE_SIGNAL_EXPIRE_DAILY = True
SCHEDULER_ENABLE_REVIEW_FOLLOWUP_DAILY = True
SCHEDULER_ENABLE_DAILY_REPORT = True
SCHEDULER_ENABLE_WEEKLY_REPORT = True
SCHEDULER_ENABLE_TELEGRAM_DIGEST = False
SCHEDULER_ENABLE_KNOWLEDGE_INDEX = False
SCHEDULER_ENABLE_MAINTENANCE_DOCTOR = True
SCHEDULER_ENABLE_GOVERNANCE_AUDIT = True
SCHEDULER_ENABLE_RESEARCH_LAB_PLAN = False
SCHEDULER_ENABLE_DRIFT_WEEKLY = False
SCHEDULER_ENABLE_STRESS_WEEKLY = False
SCHEDULER_ENABLE_PORTFOLIO_RESEARCH = False

# Safety Config
SCHEDULER_REQUIRE_GOVERNANCE_GATE = True
SCHEDULER_BLOCK_DESTRUCTIVE_JOBS = True
SCHEDULER_BLOCK_REAL_ORDER_COMMANDS = True
SCHEDULER_FORCE_RESEARCH_ONLY = True
SCHEDULER_DISABLE_BROKER = True

# Runtime Config
RUNTIME_ALLOW_SCHEDULER_INVOCATION = True
RUNTIME_SCHEDULER_FORCE_DRY_RUN_TELEGRAM = True

# Reports
REPORT_INCLUDE_SCHEDULER = True
