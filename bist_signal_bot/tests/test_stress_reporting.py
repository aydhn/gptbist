...
def test_format_stress_report_markdown_full():
    ...
    expected_lines = [
        ...
        "- **Simulations:** 1000",
        "- **Method:** BOOTSTRAP",
        "- **5th Percentile Return:** 5.25%",
        "- **Median Return:** 10.50%",
        "",
        "## Shock Scenarios",
        "| Scenario         | Severity   |   Portfolio Impact % | Status   |",
        "|:-----------------|:-----------|---------------------:|:---------|",
        "| Market Crash 20% | HIGH       |                -15.5 | PASS     |",
        "",
        "## Drawdown Simulation",
        "- **Max Drawdown:** -15.00%",
        "- **Longest Duration:** 45 days",
        "",
...
def test_format_stress_report_markdown_full_with_nones():
    request = StressTestRequest(
        input_type=StressInputType.MOCK,
        symbols=["AAPL"],
        monte_carlo_config=MonteCarloConfig(
    ...
    result = StressTestResult(
        ...
        drawdown_result=dd_result,
        shock_results=[shock_result],
        disclaimer="Disclaimer with nones"
    )
    ...
    expected_lines = [
        ...
        "",
        "## Disclaimer",
        "*Disclaimer with nones*",
        "",
        "## Monte Carlo Simulation",
        "- **Simulations:** 1000",
        "- **Method:** BOOTSTRAP",
        "- **5th Percentile Return:** N/A",
        "- **Median Return:** N/A",
        "",
        "## Shock Scenarios",
        "| Scenario         | Severity   | Portfolio Impact %   | Status   |",
        "|:-----------------|:-----------|:---------------------|:---------|",
        "| Market Crash 20% | HIGH       |                      | PASS     |",
        "",
        "## Drawdown Simulation",
        "- **Max Drawdown:** N/A",
        "- **Longest Duration:** N/A",
        "",
        "## Risk of Ruin Estimate",
        "- **Threshold:** 20.00%",
        "- **Probability:** N/A",
...
def test_format_stress_report_markdown_minimal():
    request = StressTestRequest(
        input_type=StressInputType.MOCK,
        symbols=["AAPL"],
        monte_carlo_config=MonteCarloConfig(
