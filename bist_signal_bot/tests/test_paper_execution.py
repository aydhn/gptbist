...
from bist_signal_bot.paper.models import PaperOrderSide, PaperExecutionMode, PaperLedgerState, PaperAccount
...
def test_execution_latest_close(sample_df):
    ...
    order = om.create_market_order("a", "ASELS", PaperOrderSide.BUY, 10)
...
def test_execution_buy_logic(sample_df):
    ...
    order1 = om.create_market_order("a", "ASELS", PaperOrderSide.BUY, 10)
    ...
    order2 = om.create_market_order("a", "ASELS", PaperOrderSide.BUY, 10)
...
def test_execution_sell_logic():
    ...
    o_buy = om.create_market_order("a", "A", PaperOrderSide.BUY, 10)
    ...
    o_sell1 = om.create_market_order("a", "A", PaperOrderSide.SELL, 5)
    ...
    o_sell2 = om.create_market_order("a", "A", PaperOrderSide.SELL, 5)
...
def test_execution_rejections():
    ...
    o_buy = om.create_market_order("a", "A", PaperOrderSide.BUY, 100)
    om.accept_order(o_buy)
    ...
    o_sell = om.create_market_order("a", "B", PaperOrderSide.SELL, 10)
